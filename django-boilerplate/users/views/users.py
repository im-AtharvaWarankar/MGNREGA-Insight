...
from users.serializers import (
    UsersSerializer,
    # UsersDevicesSerializer,  # Not used in CivicView
    # RegisterSerializer,  # Not used in CivicView
    # UploadProfilePictureSerializer,  # Not used in CivicView
    # ResendOTPSerializer,  # Not used in CivicView
    # VerifyAccountSerializer  # Not used in CivicView
)
from users.filters import UsersFilter
# Commented out - filter not used in CivicView
# from users.filters import UsersDevicesFilter
...
# Commented out - AWS upload not used in CivicView
# from utils.aws_script import upload_image
# Commented out - OTP and email features not used in CivicView
...
class UsersView(AtomicViewSet):
    ...
    # COMMENTED OUT — Not used in CivicView (no profile uploads)
    ...
    #     }
    #     serialized_data = UploadProfilePictureSerializer(
...
# COMMENTED OUT — Not used in CivicView (no public user registration)
...
# COMMENTED OUT — Not used in CivicView (no OTP functionality)
...
# COMMENTED OUT — Not used in CivicView (no account verification)
...
# COMMENTED OUT — Not used in CivicView (no user devices tracking)
