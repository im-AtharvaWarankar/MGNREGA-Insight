...
# Commented out - views not used in CivicView
# from .views.users import UsersDevicesView, RegisterUserView
...
# Commented out - route not used in CivicView
# router.register('users-devices', UsersDevicesView, basename='users-devices')

urlpatterns = [
    # Commented out - endpoint not used in CivicView (no public registration)
